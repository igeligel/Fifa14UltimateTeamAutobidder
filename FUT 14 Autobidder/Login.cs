...
namespace FUT_14_Autobidder
{
    public class Login
    {
        ...
        public void StartLogin()
        {
            ...
            StartLogin2(initialLogin, iframeUrl);
        }

        public void StartLogin2(string initialLogin, string iframeUrl)
        {
            //Schritt 1
            ...
            while (retries < 60 && finishedAuth == false)
            {
        ...
        public string login_1(string url)
        {
            ...
            string location;
            request2.Host = "www.easports.com";
            request2.UserAgent = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:25.0) Gecko/20100101 Firefox/25.0";
